...
const Works = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div id="thisSite" style={{ ...portfolioItemStyles }}>
          <div
            className="swipeRightIcon"
            style={{
              width: "15vmin",
              height: "15vmin",
              position: "absolute",
          ...
          <div className="itemDescription" style={{}}>
            This site is a React app. I coded it with responsive design, screen-by-screen navigation, parallax
            scrolling, javascript animations, digital art and media, state management with react hooks and state
            machines
          </div>
        </div>

        <div id="halfDouble" style={portfolioItemStyles}>
          <div
          ...
          <div className="itemDescription" style={{}}>
            Half double is a game I coded where the user is assigned a random "target number" that is a multiple of 2.
            the user must go up or down step by step which either doubles or halves their "current number" until it
            matches the target number. The user trie,s to get as many matches as possible before the minute is up. I
            coded it with React using responsive design, state management using state machines, browser storage, custom
            fonts
            <br /> <br />
            <a
              style={{
